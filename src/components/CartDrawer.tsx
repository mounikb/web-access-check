      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-0 right-0 bottom-0 z-[80] w-full max-w-md glass-strong border-l border-border/30 flex flex-col"
          >
            {/* Header */}
                ...
                items.map((item) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[11px] text-primary/60 mb-2">{item.product.category}</p>
            ...
            {items.length > 0 && (
              <div className="p-6 border-t border-border/20 space-y-4">
                ...
                <Button className="w-full bg-primary text-primary-foreground hover:bg-primary/90 font-display font-semibold btn-glow btn-shine relative z-10">
                  Checkout
                </Button>
                <p className="text-[10px] text-center text-muted-foreground/60">Free shipping on orders over ₹2,999</p>
              </div>
            )}
          </motion.div>
        </>
